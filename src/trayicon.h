...
public:
	...
	trayicon(QWidget *parent) : QSystemTrayIcon(parent)
	{
        ...
        kbLayouts->addAction(QIcon(), "English (US)",this, [=](){ emit keymapSwitch(1);});
        kbLayouts->addAction(QIcon(), "English (UK)",this, [=](){ emit keymapSwitch(2);});
        kbLayouts->addAction(QIcon(), "German (DE)",this, [=](){ emit keymapSwitch(3);});
        kbLayouts->addAction(QIcon(), "Italian (IT)",this, [=](){ emit keymapSwitch(4);});
        kbLayouts->addAction(QIcon(), "Romanian (RO)",this, [=](){ emit keymapSwitch(5);});
